...
public class Main7 implements Serializable {
    ...
    public static void doAction(int menuNumber){
        switch(menuNumber){
            ...
            case 6: HR.deleteEmployeeByID(Human_Resourse.selectEmployeeID()); break;
            case 7: Human_Resourse.saveEmployees(HR); break;
            case 0:
                System.exit(0);
            default:
                System.out.println("\nWrong Entry");
