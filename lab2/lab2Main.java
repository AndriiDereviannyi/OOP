    ...
    public static void doAction(char menuNumber) {
        ...
        switch (menuNumber) {
            case 'a':
                ...
                System.out.println("\nLetters one by one and Size They Occupy in ListContainer(toString + size):");
                System.out.println(letters.toString());
                System.out.println(letters.size() + "\n");

                System.out.println("Vowels After Removing 'a' and Size They Occupy in Containers(remove):");
                System.out.println(vowels.remove("a"));
                System.out.println(vowels.toString());
                System.out.println(vowels.size() + "\n");

                System.out.println("Vowels ListContainer Contains 'a'(contains):");
                System.out.println(vowels.contains("a" + "\n"));

                System.out.println("\nAll Letters Are Present in Vowels ListContainer(containsAll):");
